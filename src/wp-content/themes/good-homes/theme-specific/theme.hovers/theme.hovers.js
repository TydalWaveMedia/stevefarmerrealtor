...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	...
	if (GOOD_HOMES_STORAGE['button_hover'] && GOOD_HOMES_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.good_homes_tabs .good_homes_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+GOOD_HOMES_STORAGE['button_hover']);
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.good_homes_tabs .good_homes_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+GOOD_HOMES_STORAGE['button_hover']);
