...
if (!function_exists('good_homes_customizer_get_css')) {

	function good_homes_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = good_homes_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('good_homes_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(good_homes_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = good_homes_get_scheme_colors($scheme);
...
.search.search-no-results .search_wrap .search_submit{
	color: {$colors['text_dark']};
}
...
.widget_area .post_item .post_info .post_info_item a, .widget .post_item .post_info .post_info_item a{
    color: {$colors['alter_text']};
}
...
.comments_wrap .comments_field input::-webkit-input-placeholder {color:{$colors['text_light']}; opacity: 1;}
.comments_wrap .comments_field input::-moz-placeholder          {color:{$colors['text_light']}; opacity: 1;}/* Firefox 19+ */
.comments_wrap .comments_field input:-moz-placeholder           {color:{$colors['text_light']}; opacity: 1;}/* Firefox 18- */
.comments_wrap .comments_field input:-ms-input-placeholder      {color:{$colors['text_light']}; opacity: 1;}

.comments_wrap .comments_field textarea::-webkit-input-placeholder {color:{$colors['text_light']}; opacity: 1;}
.comments_wrap .comments_field textarea::-moz-placeholder          {color:{$colors['text_light']}; opacity: 1;}/* Firefox 19+ */
.comments_wrap .comments_field textarea:-moz-placeholder           {color:{$colors['text_light']}; opacity: 1;}/* Firefox 18- */
.comments_wrap .comments_field textarea:-ms-input-placeholder      {color:{$colors['text_light']}; opacity: 1;}

.sc_form_form input::-webkit-input-placeholder {color:{$colors['text_light']}; opacity: 1;}
.sc_form_form input::-moz-placeholder          {color:{$colors['text_light']}; opacity: 1;}/* Firefox 19+ */
.sc_form_form input:-moz-placeholder           {color:{$colors['text_light']}; opacity: 1;}/* Firefox 18- */
.sc_form_form input:-ms-input-placeholder      {color:{$colors['text_light']}; opacity: 1;}

.sc_form_form textarea::-webkit-input-placeholder {color:{$colors['text_light']}; opacity: 1;}
.sc_form_form textarea::-moz-placeholder          {color:{$colors['text_light']}; opacity: 1;}/* Firefox 19+ */
.sc_form_form textarea:-moz-placeholder           {color:{$colors['text_light']}; opacity: 1;}/* Firefox 18- */
.sc_form_form textarea:-ms-input-placeholder      {color:{$colors['text_light']}; opacity: 1;}
...
.body_style_boxed header.top_panel{
	color: {$colors['text_link']};
}
...
/* Title */
.sc_item_title_style_line_above_left:before, .sc_item_title_style_line_under_center:before, .sc_item_title.sc_item_title_style_line_under_right:before, .sc_item_title.sc_item_title_style_line_under_left:before{
    background-color: {$colors['extra_bd_hover_05']};
}
.sc_item_title_style_line_above_left:after, .sc_item_title_style_line_under_center:after, .sc_item_title.sc_item_title_style_line_under_right:after, .sc_item_title.sc_item_title_style_line_under_left:after{
    background-color: {$colors['text_link']};
}
.sc_testimonials_title.sc_item_title_style_line_above_left:before, .sc_testimonials_title.sc_item_title_style_line_under_center:before, .sc_testimonials_title.sc_item_title.sc_item_title_style_line_under_right:before, .sc_testimonials_title.sc_item_title.sc_item_title_style_line_under_left:before{
    background-color: {$colors['bd_color_01']};
}
.scheme_self.sc_title .sc_item_title.sc_item_title_style_line_under_center:before {
 	background-color: {$colors['bd_color_05']};
}
.scheme_self.sc_title .sc_item_title_style_line_under_center:after {
...
.good_homes_tabs .good_homes_tabs_titles li a:hover {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.good_homes_tabs .good_homes_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.post_counters_item.post_meta_item:before, .post_item_single .post_header .post_counters_item.post_meta_item:before{
    color: {$colors['text_dark']};
}
...
.trx_addons_audio_player.without_cover .audio_author, .format-audio .post_featured .post_audio_author{
	color: {$colors['alter_text']};
}
...
.scheme_self.author_info .author_title span {
	color: {$colors['text_link']};
}
...
.sidebar .widget_categories ul > li a:hover:before, .sidebar .widget.widget_meta li a:hover:before{
    color: {$colors['text_link']};
}
.sidebar .widget_categories ul > li a:hover, .sidebar .widget.widget_meta li a:hover{
    color: {$colors['text_link']};
}
...
CSS;
					...
					$rez = apply_filters('good_homes_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'good_homes_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>