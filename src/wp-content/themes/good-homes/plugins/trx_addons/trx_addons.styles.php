...
if (!function_exists('good_homes_trx_addons_get_css')) {
	add_filter('good_homes_filter_get_css', 'good_homes_trx_addons_get_css', 10, 4);
	function good_homes_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.body_style_boxed footer .sc_layouts_item_icon {
...
.body_style_boxed .footer_wrap .socials_wrap .social_item .social_icon{
	color: {$colors['text_dark']};
	border-color: {$colors['text_dark']};
}
.body_style_boxed .footer_wrap .socials_wrap .social_item .social_icon:hover{
	color: {$colors['text_link']};
	border-color: {$colors['text_link']};
}
.sc_layouts_row_fixed_on, .sc_layouts_row_type_normal.sc_layouts_row_fixed.sc_layouts_row_fixed_on {
	background-color: {$colors['bg_color']}!important;
}
.body_style_boxed .footer_copy .widget.widget_text a {
	color: {$colors['text_link']};
}

.body_style_boxed .footer_copy .widget.widget_text a:hover {
	color: {$colors['text_dark']};
}
...
.sc_layouts_row_type_narrow .sc_layouts_login_details .sc_layouts_item_details_line2.sc_layouts_iconed_text_line2:hover{
	color: {$colors['inverse_text']};
	background-color: {$colors['inverse_bd_hover']};
}
 
.sc_layouts_row_type_narrow .sc_layouts_login_details .sc_layouts_item_details_line2.sc_layouts_iconed_text_line2:hover:before{
	color: {$colors['inverse_text']};
}
.sc_layouts_row_type_narrow .sc_layouts_login_details .sc_layouts_item_details_line1.sc_layouts_iconed_text_line1:hover{
	color: {$colors['inverse_text']};
}
...
.sc_layouts_row_type_compact .search_wrap input.search_field[type="text"]{
	border-color: {$colors['bd_color']};
}
...
.sc_layouts_menu_nav li a, .sc_layouts_menu_nav ul li:last-child a{
...
.sc_layouts_row_type_normal .sc_layouts_menu_nav > li.sfHover > a {
	color: {$colors['text_link']} !important;
}
...
ul.trx_addons_list_dot_black > li:before{
	color: {$colors['text_hover']};
}
...
.sc_form_form .sc_form_field_button button:hover{
	background-color: {$colors['text_link']};
}
...
.sc_price_default:hover .sc_price_info .sc_price_price{
	color: {$colors['text_link']};
}
...
.properties_search_form .properties_search_basic, .properties_search_opened .properties_search_form .properties_search_advanced{
	background-color: {$colors['bg_color']};
}
...
.sc_properties.sc_properties_default .sc_properties_item.with_image.with_content {
    background-color: {$colors['alter_bg_color']};
}
.sc_properties.sc_properties_default .bg_color_white .sc_properties_item.with_image.with_content{
	background-color: {$colors['bg_color']};
}
.sc_properties.sc_properties_default .sc_properties_item_option, 
.sc_properties.sc_properties_default .sc_properties_item_option .properties_address_item a{
	color: {$colors['text_dark']};
}
.sc_properties.sc_properties_default .properties_price_label.properties_price_before, .properties_price_data{
	color: {$colors['text_link']};
}
...
.sc_properties_item_button.sc_item_button .sc_button:hover{
	background-color: {$colors['text_link']}!important;
}
...
.sc_properties_item_compare.in_compare_list:before{
	color: {$colors['text_link']};
}
.sc_properties.sc_properties_slider .sc_properties_item_option .properties_address_item, 
.sc_properties.sc_properties_slider .sc_properties_item_option .properties_address_item a{
	color: {$colors['extra_text']};
}

.sc_properties.sc_properties_slider .properties_price .properties_price_before{
	color: {$colors['text_link']};
}
.sc_properties_slider_content_column.first span, .sc_properties_slider_content_column.second span{
	color: {$colors['text_dark']};
} 
.sc_properties_slider_content_column.first span a{
	color: {$colors['text_dark']};
}
.sc_properties_slider_content_column.second{
	border-color: {$colors['alter_bd_color']};
}
.sc_properties.sc_properties_slider .sc_properties_slider_columns {
	background-color: {$colors['alter_bg_color']};
}
.properties_search_form .properties_search_basic .properties_search_show_advanced{
	background-color: {$colors['bg_color']};
}
.properties_search_form .properties_search_basic .properties_search_show_advanced:before{
	color: {$colors['text_dark']};
}

.properties_search_form .properties_search_basic input, 
.properties_search_form .properties_search_basic select,
.properties_search_form .properties_search_advanced input, 
.properties_search_form .properties_search_advanced select, 
...
.properties_search_form .properties_search_basic .select_container:hover:before,
.properties_search_form .properties_search_advanced .select_container:hover:before {
...
.properties_search_form .sc_form_field.sc_form_field_checkbox label{
	color: {$colors['text_dark']};
}
...
.sc_services_default .sc_services_item.with_content.with_image .sc_services_item_button .sc_button.sc_button_simple:hover{
	background-color: {$colors['text_link']};
...
.sc_services_default.sc_services_featured_top.sc_services .sc_services_item:hover .sc_services_item_title a{
	color: {$colors['inverse_text']};
}
.sc_services_default.sc_services_featured_top.sc_services .sc_services_item:hover .sc_services_item_title a:hover{
	color: {$colors['text_link']};
}
.sc_services_default.sc_services_featured_top.sc_services .sc_services_item:hover{
	color: {$colors['inverse_text']};
	background-color: {$colors['text_dark']};
}
.sc_services_default .sc_services_item.with_content.with_image:hover .sc_services_item_button .sc_button.sc_button_simple{
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link']};
}
...
div.wpcf7 span.Date input::-webkit-input-placeholder {color:{$colors['text_dark']}; opacity: 1;}
div.wpcf7 span.Date input::-moz-placeholder          {color:{$colors['text_dark']}; opacity: 1;}/* Firefox 19+ */
div.wpcf7 span.Date input:-moz-placeholder           {color:{$colors['text_dark']}; opacity: 1;}/* Firefox 18- */
div.wpcf7 span.Date input:-ms-input-placeholder      {color:{$colors['text_dark']}; opacity: 1;}


div.wpcf7 span.Time input::-webkit-input-placeholder {color:{$colors['text_dark']}; opacity: 1;}
div.wpcf7 span.Time input::-moz-placeholder          {color:{$colors['text_dark']}; opacity: 1;}/* Firefox 19+ */
div.wpcf7 span.Time input:-moz-placeholder           {color:{$colors['text_dark']}; opacity: 1;}/* Firefox 18- */
div.wpcf7 span.Time input:-ms-input-placeholder      {color:{$colors['text_dark']}; opacity: 1;}
...
.footer_wrap .widget.widget_nav_menu .menu li a, .footer_wrap .widget.widget_nav_menu .menu li a:before{
	color: {$colors['alter_text']};
}
.footer_wrap .widget.widget_nav_menu .menu li a:hover, .footer_wrap .widget.widget_nav_menu .menu li a:hover:before{
	color: {$colors['text_link']};
}
.scheme_self.footer_wrap .widget.widget_nav_menu .menu li, .scheme_self.footer_wrap .widget.widget_nav_menu .menu li:last-child{
	border-color: {$colors['extra_bd_color']};	
}
...
.sc_testimonials_slider.sc_item_slider.slider_outer_controls_bottom .slider_controls_wrap > a:hover{
	border-color: {$colors['inverse_text']};
	color: {$colors['inverse_text']};
	background-color: transparent;
}
