...
if ( !function_exists( 'good_homes_vc_get_css' ) ) {
	add_filter( 'good_homes_filter_get_css', 'good_homes_vc_get_css', 10, 4 );
	function good_homes_vc_get_css($css, $colors, $fonts, $scheme='') {
