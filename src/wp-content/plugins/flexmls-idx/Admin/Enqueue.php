...
class Enqueue {
	...
	static function admin_enqueue_scripts( $hook ){
		...
		if( defined( 'FMC_DEV' ) && FMC_DEV ){
			...
			wp_enqueue_script( 'fmc_location_search', plugins_url( 'src/js/location_search.js', dirname( __FILE__ ) ), array( 'jquery' ), time() );
			
			wp_enqueue_script( 'fmc_admin_location_search', plugins_url( 'src/js/admin/admin_location_search.js', dirname( __FILE__ ) ), array( 'jquery' ), time() );
	...
	static function wp_enqueue_scripts(){
		...
		if( defined( 'FMC_DEV' ) && FMC_DEV ){
			wp_enqueue_script( 'fmc_location_search', plugins_url( 'src/js/location_search.js', dirname( __FILE__ ) ), array( 'jquery' ), time() );
			wp_enqueue_script( 'fmc_search_widget', plugins_url( 'src/js/search_widget.js', dirname( __FILE__ ) ), array( 'jquery' ), time() );
