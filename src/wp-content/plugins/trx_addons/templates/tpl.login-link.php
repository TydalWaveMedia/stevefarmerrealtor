...
if ( !is_user_logged_in() ) {
	?><a href="#trx_addons_login_popup" class="trx_addons_popup_link trx_addons_login_link "><?php
		...
		?><span class="sc_layouts_item_details sc_layouts_login_details"><?php
			...
			if (!empty($rows[1])) {
				?><span class="sc_layouts_item_details_line1 sc_layouts_iconed_text_line1"><?php echo esc_html($rows[1]); ?></span><?php
			}
			if (!empty($rows[0])) {
				?><span class="sc_layouts_item_details_line2 sc_layouts_iconed_text_line2"><?php echo esc_html($rows[0]); ?></span><?php
			}
		?></span><?php
	?></a><?php
