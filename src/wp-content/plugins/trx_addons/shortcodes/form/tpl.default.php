...
?>>
	...
	<form class="sc_form_form <?php if ($form_style != 'default') echo 'sc_input_hover_'.esc_attr($form_style); ?>" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>">
        ...
        <span class="label_field_req"><?php esc_html_e('Your email address will not be published. Required fields are marked *', 'basekit'); ?></span>
        <?php
		...
		?></div>
		<div class="sc_form_field sc_form_field_button"><button><?php esc_html_e('Send', 'trx_addons'); ?></button></div>
