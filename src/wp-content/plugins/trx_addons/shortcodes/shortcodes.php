...
*/
			...
			'title' => array(
							...
							'layouts_sc' => array(
								...
								'line_above_left' => esc_html__('Line Above Left', 'trx_addons'),
								'line_under_center' => esc_html__('Line Under Center', 'trx_addons'),
								'line_under_right' => esc_html__('Line Under Right', 'trx_addons'),
								'line_under_left' => esc_html__('Line Under Left', 'trx_addons'),
							)
						)
			)
		);
