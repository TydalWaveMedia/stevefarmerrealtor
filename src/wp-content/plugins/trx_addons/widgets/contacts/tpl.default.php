...
if ($show_info || !empty($googlemap)) {
	...
	if (!empty($address) || !empty($phone) || !empty($email)) {
        ...
        if (!empty($phone) || !empty($email)) {
            ...
            if (!empty($phone)) {
                ?><span class="contacts_phone"><?php esc_html_e('Phone Number', 'trx_addons'); ?></span>
                <span class="phone"><?php echo wp_kses_data($phone); ?></span><?php
            }
            if (!empty($email)) {
                ?><span class="contacts_email"><?php esc_html_e('Email', 'trx_addons'); ?></span>
                <span class="email"><a href="mailto:<?php echo antispambot($email); ?>"><?php echo antispambot($email); ?></a></span><?php
            }
			...
			if (!empty($address)) {
				...
				?><span class="contacts_address"><?php esc_html_e('Location', 'trx_addons'); ?></span>
                <span class="address"><?php echo str_replace('|', "<br>", $address); ?></span><?php
