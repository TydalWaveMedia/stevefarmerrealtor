<?php
/**
 * The style "short_left " of the Team
 *
 * @package WordPress
...
<div class="sc_team_item">
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
												...
												'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('avatar'), 'team-short_left'),
	...
	?>
	<div class="sc_team_item_info short_left">
		<div class="sc_team_item_header">
			<h4 class="sc_team_item_title"><a href="<?php echo esc_url($link); ?>"><?php the_title(); ?></a></h4>
        <?php
        if (!empty($meta['phone'])) {
            ?><div class="sc_team_item_phone"><?php echo esc_html($meta['phone']);?></div><?php
        }
        ?>
		</div>
	</div>
