...
if (!function_exists('trx_addons_cpt_cars_init')) {
	...
	function trx_addons_cpt_cars_init() {
		...
		register_post_type( TRX_ADDONS_CPT_CARS_PT, array(
			...
			'show_in_menu'        => true,
			'menu_position'       => '52.0',
			'menu_icon'			  => trx_addons_get_file_url('cpt/cars/cars-icon.png'),
...
if (!function_exists('trx_addons_cpt_cars_options')) {
	add_action( 'trx_addons_filter_options', 'trx_addons_cpt_cars_options');
...
if ( !function_exists( 'trx_addons_cpt_cars_load_scripts_front' ) ) {
	...
	function trx_addons_cpt_cars_load_scripts_front() {
		if (trx_addons_is_on(trx_addons_get_option('debug_mode'))) {
			wp_enqueue_style( 'trx_addons-cpt_cars', trx_addons_get_file_url('cpt/cars/cars.css'), array(), null );
			wp_enqueue_script('trx_addons-cpt_cars', trx_addons_get_file_url('cpt/cars/cars.js'), array('jquery'), null, true );
		}
	}
}
...
if ( !function_exists( 'trx_addons_cpt_cars_load_scripts_admin' ) ) {
	...
	function trx_addons_cpt_cars_load_scripts_admin() {
		wp_enqueue_script('trx_addons-cpt_cars', trx_addons_get_file_url('cpt/cars/cars.admin.js'), array('jquery'), null, true );
	}
}
...
if ( !function_exists( 'trx_addons_cpt_cars_single_template' ) ) {
	...
	function trx_addons_cpt_cars_single_template($template) {
		...
		if (is_single() && $post->post_type == TRX_ADDONS_CPT_CARS_PT)
			$template = trx_addons_get_file_dir('cpt/cars/tpl.cars.single.php');
		return $template;
	}
}
...
if ( !function_exists( 'trx_addons_cpt_cars_archive_template' ) ) {
	...
	function trx_addons_cpt_cars_archive_template( $template ) {
		if ( is_post_type_archive(TRX_ADDONS_CPT_CARS_PT) ) {
			if ((int) trx_addons_get_value_gp('compare') == 1)
				$template = trx_addons_get_file_dir('cpt/cars/tpl.cars.compare.php');
			else
...
if ( !function_exists( 'trx_addons_sc_cars' ) ) {
	function trx_addons_sc_cars($atts, $content=null) {	
		...
		trx_addons_get_template_part(array(
										'cpt/cars/tpl.cars.'.trx_addons_esc($atts['type']).'.php',
										'cpt/cars/tpl.cars.default.php'
										),
		...
		$params = array_merge(
				array(
					...
					array(
						...
						"admin_label" => true,
						'edit_field_class' => 'vc_col-sm-4 vc_new_row',
						"value" => array_flip(trx_addons_cpt_cars_get_list_transmission()),
						"std" => "none",
						"type" => "dropdown"
					),
					array(
						...
						"admin_label" => true,
						'edit_field_class' => 'vc_col-sm-4',
						"value" => array_flip(trx_addons_cpt_cars_get_list_type_of_drive()),
						"std" => "none",
						"type" => "dropdown"
					),
					array(
						...
						"admin_label" => true,
						'edit_field_class' => 'vc_col-sm-4',
						"value" => array_flip(trx_addons_cpt_cars_get_list_fuel()),
						"std" => "none",
						"type" => "dropdown"
					),
				),
...
if (!function_exists('trx_addons_cpt_cars_slider_content')) {
	...
	function trx_addons_cpt_cars_slider_content($image, $args) {
		if (get_post_type() == TRX_ADDONS_CPT_CARS_PT) {
			$image['content'] = trx_addons_get_template_part_as_string('cpt/cars/tpl.cars.slider-slide.php',
...
//----------------------------------------------------------------------------
if ( ($fdir = trx_addons_get_file_dir("cpt/cars/cars.taxonomy_type.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/cars/cars.taxonomy_status.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/cars/cars.taxonomy_maker.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/cars/cars.taxonomy_model.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/cars/cars.taxonomy_features.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/cars/cars.taxonomy_labels.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/cars/cars.taxonomy_city.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/cars/cars.agents.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/cars/widget.cars_compare.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/cars/widget.cars_sort.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/cars/widget.cars_search.php")) != '') { include_once $fdir; }
?>