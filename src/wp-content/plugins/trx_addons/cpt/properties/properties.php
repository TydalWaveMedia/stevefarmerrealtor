...
if (!function_exists('trx_addons_cpt_properties_options')) {
	add_action( 'trx_addons_filter_options', 'trx_addons_cpt_properties_options');
...
if ( !function_exists( 'trx_addons_cpt_properties_load_scripts_front' ) ) {
	...
	function trx_addons_cpt_properties_load_scripts_front() {
		if (trx_addons_is_on(trx_addons_get_option('debug_mode'))) {
			wp_enqueue_style( 'trx_addons-cpt_properties', trx_addons_get_file_url('cpt/properties/properties.css'), array(), null );
			wp_enqueue_script('trx_addons-cpt_properties', trx_addons_get_file_url('cpt/properties/properties.js'), array('jquery'), null, true );
		}
	}
}
...
if ( !function_exists( 'trx_addons_cpt_properties_merge_styles' ) ) {
	...
	function trx_addons_cpt_properties_merge_styles($list) {
		$list[] = 'cpt/properties/properties.css';
		return $list;
	}
}
...
if ( !function_exists( 'trx_addons_cpt_properties_merge_scripts' ) ) {
	...
	function trx_addons_cpt_properties_merge_scripts($list) {
		$list[] = 'cpt/properties/properties.js';
		return $list;
	}
}
...
if ( !function_exists( 'trx_addons_cpt_properties_load_scripts_admin' ) ) {
	...
	function trx_addons_cpt_properties_load_scripts_admin() {
		wp_enqueue_script('trx_addons-cpt_properties', trx_addons_get_file_url('cpt/properties/properties.admin.js'), array('jquery'), null, true );
	}
}
...
if ( !function_exists( 'trx_addons_cpt_properties_single_template' ) ) {
	...
	function trx_addons_cpt_properties_single_template($template) {
		...
		if (is_single() && $post->post_type == TRX_ADDONS_CPT_PROPERTIES_PT)
			$template = trx_addons_get_file_dir('cpt/properties/tpl.properties.single.php');
		return $template;
	}
}
...
if ( !function_exists( 'trx_addons_cpt_properties_archive_template' ) ) {
	...
	function trx_addons_cpt_properties_archive_template( $template ) {
		if ( is_post_type_archive(TRX_ADDONS_CPT_PROPERTIES_PT) ) {
			if ((int) trx_addons_get_value_gp('compare') == 1)
				$template = trx_addons_get_file_dir('cpt/properties/tpl.properties.compare.php');
			else
				$template = trx_addons_get_file_dir('cpt/properties/tpl.properties.archive.php');
		}
		return $template;
	}	
}
...
if ( !function_exists( 'trx_addons_sc_properties' ) ) {
	function trx_addons_sc_properties($atts, $content=null) {	
		...
		trx_addons_get_template_part(array(
										'cpt/properties/tpl.properties.'.trx_addons_esc($atts['type']).'.php',
										'cpt/properties/tpl.properties.default.php'
										),
	...
	function trx_addons_sc_properties_add_in_vc_params() {
		...
		$params = array_merge(
				array(
                    ...
                    array(
                        "param_name" => "bg_color_column",
                        "heading" => esc_html__("Background Color", 'trx_addons'),
                        "description" => wp_kses_data( __("Change background color", 'trx_addons') ),
                        'edit_field_class' => 'vc_col-sm-4',
                        "std" => "0",
                        "value" => array(esc_html__("Change background color", 'trx_addons') => "1" ),
                        "type" => "checkbox"
                    ),
					array(
...
if (!function_exists('trx_addons_cpt_properties_slider_content')) {
	...
	function trx_addons_cpt_properties_slider_content($image, $args) {
		if (get_post_type() == TRX_ADDONS_CPT_PROPERTIES_PT) {
			$image['content'] = trx_addons_get_template_part_as_string('cpt/properties/tpl.properties.slider-slide.php',
...
//----------------------------------------------------------------------------
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/properties.taxonomy_type.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/properties.taxonomy_status.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/properties.taxonomy_features.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/properties.taxonomy_labels.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/properties.taxonomy_country.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/properties.taxonomy_state.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/properties.taxonomy_city.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/properties.taxonomy_neighborhood.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/properties.agents.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/widget.properties_compare.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/widget.properties_sort.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/properties/widget.properties_search.php")) != '') { include_once $fdir; }
?>