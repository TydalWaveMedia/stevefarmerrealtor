...
?>">
    ...
    <div class="sc_properties_item_price"><?php  echo(trx_addons_get_template_part_as_string(
		...
		<div class="sc_properties_item_options">
			...
			<div class="sc_properties_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="sc_button"><?php esc_html_e('View Offer', 'trx_addons'); ?></a></div><?php
    ...
    ?><span class="icon_status"></span></div>
